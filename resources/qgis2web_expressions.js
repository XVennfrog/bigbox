...
function exp_label_BigBoxProperties0100_4_eval_expression(context) {
    // if(left(address, 2) = '0 ', title(substr(address, 2, 99)), title(address))

    var feature = context.feature;
    
    if (feature.properties) {
        return fnc_if([(fnc_left([feature.get('address') ,2], context) == '0 '),fnc_title([fnc_substr([feature.get('address') ,2,99], context)], context),fnc_title([feature.get('address') ], context)], context);
    } else {
        return fnc_if([(fnc_left([feature.get('address') ,2], context) == '0 '),fnc_title([fnc_substr([feature.get('address') ,2,99], context)], context),fnc_title([feature.get('address') ], context)], context);
    }
}